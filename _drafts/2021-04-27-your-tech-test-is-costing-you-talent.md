...
description: The technical hiring process can be a critical stage in attracting diverse and amazing candidates. Here are 10 things you can do right now to make your hiring process more compassionate, take less time for the candidate and your staff and find you amazing people.
layout: post
categories: [hiring]
---
...
No one enjoys being greeted with a 10 stage interview process. Most interviews I've done have ranged from 3 hours all the way to 15 hours+. Elitist hiring thinks we are 'weeding out the candidates that won't fit, and making people do lots of tests and trials makes the company a kind of exclusive club. In reality, the more hoops to jump through the less likely you are to find and attract diverse people that really fit your needs.
...
Compassionate hiring says let's do the minimum we need to do to make sure you get your questions answered and we get reasonable confidence that you are a great addition to the team.
...
We should avoid the opposite end of the scale where the entire interview is only a 45 min chat with the CTO because the candidate doesn't get time to meet the team or answer their questions about the business.
...
### Challenge Yourself
Use your new job requirements list to come up with the lightest possible process that directly addresses these and whether a candidate fits the bill or not. Keep the entire interview process under 3 hours maximum as a general rule. Publish this on your careers page transparently.

Ensure the process gives the candidate exposure to members of the team they will be working with _as early as possible_ so they can get answers to any questions they have and put any concerns to rest before you use it any more of their time.
...
Elitist hiring often involves a code test before the candidate even gets to meet a member of the team, often without offering the candidate a chance to explain their work and reasoning. This allegedly vets out those that don't meet a given expected standard and keeps the calibre of the team intact.

There are numerous problems with this.

### 2 Hours is Never 2 Hours
Code tests never take 2 hours, 3 hours or whatever the recommended time is. By the time you set up the testing suite, linter and everything else you need you've easily used up most of that time. Candidates are never going to admit your 2-hour tech test took 10 hours so the cycle continues.
...
There is no One True Path with coding. Coding is more like art than anything else, with lots of different ways to do the same thing that is subject to personal style and preference. Even with fairly clear instructions candidates can submit all sort of wild and wonderful solutions.
...
If your hiring process starts with a coding test and not a conversation I'm going to instantly assume you place very little value in emotional skills and 'catalytic' skills (thanks [April Wensel](https://twitter.com/aprilwensel?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor), the skills that make other things happen) and will avoid applying to your company.
...
It's easy to copy and paste code tests and automated tests but this is a sure-fire way to turn away great people. Challenge yourself to ask if you really need a coding test at all.
...
Instead of a coding test, we did a lightning talk style presentation for 10 minutes, with 20 mins for 2 of the engineers (of mixed gender/race, very important) to ask questions of the candidate and 15 mins for the candidate to ask them questions. The prep should take no more than an hour or two maximum and we had great feedback on how the candidates enjoyed getting to share their areas of interest with us.
...
- Candidates genuinely enjoyed the task, even those that were introverted.
...
- The candidate got time to ask questions to the people they would be working with on a daily basis in their team.
...
This tells the candidate nothing of substance about the approach to the code. Do you want it to be scrappy, but not crappy? Do you want it to be highly performant and able to be added to easily? Take those loose ideas and turn them into really specific concrete things you want to see:
...
Before you go subbing in a review of a candidate’s Github profile remember that 95% of open source contributors are men (see the Better Allies hiring book for reference) and women and nonbinary folks tend to have a difficult time in that space. It assumes that someone has the time and privilege to be doing that outside of work, so do this with serious caution.

## Elitist Hiring says: We're All Rockstars At Hiring
The elitist school of hiring believes that they can have a set of 'male and pale' interviewers that have never had any training or experience in doing interviews. The company is so elite that everyone should want to work there right, so why do you even need to try. If you've already attracted World Class talent into your Elite Club what is there to worry about?
