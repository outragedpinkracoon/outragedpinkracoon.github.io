...
<div class="audience-grid">
  <section class="audience-panel audience-panel--manager">
    <p class="audience-label">Newly promoted EMs</p>
    <h3>Engineers who just became managers</h3>
    <p>Promoted into people leadership, handed a team, no playbook. The transition is harder than anyone tells them. I get them effective before the damage compounds.</p>
  </section>

  <section class="audience-panel audience-panel--coaching">
    <p class="audience-label">Growing engineering leads</p>
